...
// @ts-ignore
@customElement('protobot-authoring-sidebar2')
class ProtobotAuthoringSidebar2 extends GetDomainMixin(LitElement) {
  @property()
  commitMessage;
  ...
  async nextDialogStage () {
    this.dialogStage++;
    this.dialogStage = Math.min(this.dialogStage, 2);
    // window.location.reload();
  }
...
export { ProtobotAuthoringSidebar2 };
