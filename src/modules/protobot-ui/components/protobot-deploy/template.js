...
export const template = self => function () {
  // @ts-ignore
  const { deployedVersion, submit, newDomain, numUser, changeNumUser, numSession, changeNumSession, opened, stage, deployUrl, otherResponse, changeOtherResponse, amtOption, changeAmtOption, deploy, confirmAMT, cancelAMT } = this;
  return html`
    <style>
      ${styles}
